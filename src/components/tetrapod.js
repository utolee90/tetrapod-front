...
class Tetrapod {
    ...
    // 테스트 확인
    static qwertyToDubeol(msg) {
        return Utils.qwertyToDubeol(msg, false);
    }

    static antispoof (msg) {
        return Utils.antispoof(msg, false);
    }

    static dropDouble(msg) {
        return Utils.dropDouble(msg, false, false);
    }

    static engToKo(msg) {
        return Utils.engToKo(msg, false);
    }
