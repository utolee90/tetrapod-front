...
// 기본 경로
let badWordDefaultPath = '../assets/dictionaries/bad-words.json'
let normalWordDefaultPath = '../assets/dictionaries/normal-words.json'
let macroDefaultPath = '../assets/dictionaries/macros.json'
...
class Tetrapod {
    ...
    // Utils에서 함수 가져오기 - qwertyToDobeol
    static qwertyToDubeol(message, isMap = false) {
        return isMap? Utils.parseMap(Utils.qwertyToDubeol(message, true)) : Utils.qwertyToDubeol(message, false);
    }

    static antispoof(message, isMap = false) {
        return isMap? Utils.parseMap(Utils.antispoof(message, true)): Utils.antispoof(message, false);
    }

    static engToKo(message, isMap = false) {
        return isMap? Utils.parseMap(Utils.engToKo(message, true)): Utils.engToKo(message, false);
    }

    static dropDouble(message, isMap = false, simplify = false) {
        return isMap? Utils.parseMap(Utils.dropDouble(message, true, simplify)): Utils.dropDouble(message, false, simplify);
    }
